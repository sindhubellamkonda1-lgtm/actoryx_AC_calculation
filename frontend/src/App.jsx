...
export default function App() {
  ...
  {/* Updated Recommended Unit Display */}
  <div className="bg-cyan-50 dark:bg-cyan-950 p-2 rounded text-center border border-cyan-200 dark:border-cyan-800 mt-2">
    <p className="text-[9px] font-bold text-cyan-700 dark:text-cyan-400 uppercase tracking-widest">Recommended Equipment</p>
    <p className="text-sm font-bold text-cyan-900 dark:text-cyan-100">
      {results.recommended_unit_qty} Units ({results.recommended_standard_unit} Tons Each)
    </p>
  </div>
  <div className="absolute top-0 bottom-0 left-0 w-1 bg-cyan-500"></div>
                    ...
                    <div className="bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-800 rounded-xl p-6 shadow-sm mt-6">
                      
                      {/* Ensure the ID wraps the chart, not just the title */}
<div id="thermal-chart-container" className="bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-800 rounded-xl p-6 shadow-sm mt-6">
  ...
  {/* The chart is inside this container, so html2canvas will see it */}
  <ThermalLoadChart results={results} />
</div>
                      <p className="text-[10px] text-slate-500 font-mono text-center mt-4 uppercase tracking-widest">
                        Breakdown of BTU/hr consumption by system component
                      </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                      <div onClick={() => setActiveModal('thermal')} className="bg-slate-50 dark:bg-slate-950/50 p-4 rounded-lg border border-slate-300 dark:border-slate-800 cursor-pointer hover:border-amber-400 transition-all group">
                        ...
                        <p className="text-xs text-slate-600 dark:text-slate-400 mb-2">Largest source: {primarySource.name} ({primarySource.value.toLocaleString()} BTU).</p>
  ...
  <div className="flex items-center justify-between mb-2">
    <div className="flex items-center gap-2"><AlertTriangle className="w-4 h-4 text-rose-500" /><h3 className="text-xs font-bold font-mono uppercase">Hardware Procurement</h3></div>
    <ChevronRight className="w-3 h-3 text-slate-400 opacity-0 group-hover:opacity-100" />
  </div>
  {/* Updated Text String */}
  <p className="text-xs text-slate-600 dark:text-slate-400 mb-2">Procure: {results.recommended_unit_qty} unit(s) of {results.recommended_standard_unit} Tons.</p>
  <p className="text-[11px] text-rose-600 italic font-medium">Click to learn why &rarr;</p>
                      ...
                      <div onClick={() => setActiveModal('grid')} className="bg-slate-50 dark:bg-slate-950/50 p-4 rounded-lg border border-slate-300 dark:border-slate-800 cursor-pointer hover:border-indigo-400 transition-all group">
                        <div className="flex items-center justify-between mb-2">
                          <div className="flex items-center gap-2"><Factory className="w-4 h-4 text-indigo-500" /><h3 className="text-xs font-bold font-mono uppercase">Grid Base-Load Impact</h3></div>
                          <ChevronRight className="w-3 h-3 text-slate-400 opacity-0 group-hover:opacity-100" />
                        </div>
                        <p className="text-xs text-slate-600 dark:text-slate-400 mb-2">Peak operation: {results.required_ac_kw} kW.</p>
                ...
                <div className="bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-800 rounded-xl p-6 shadow-sm">
                  <div className="flex justify-between items-center border-b border-slate-300 dark:border-slate-800 pb-4 mb-5">
                    ...
                    <button 
  onClick={() => generateReport(results, 'thermal-chart-container')} 
  className="bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-800 dark:text-slate-200 font-medium text-xs px-4 py-2 rounded-md transition-colors"
>
  Download PDF Report
</button>
                  </div>
